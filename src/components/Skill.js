...
const Skill = () => {
  ...
  useLayoutEffect(() => {
    ScrollTrigger.create({
      ...
      // markers: true,
      start: 'top 80%',
      toggleClass: { targets: markupRef.current, className: 'left-view' },
      once: true,
    });
    ScrollTrigger.create({
      ...
      // markers: true,
      start: 'top 80%',
      toggleClass: { targets: stylingRef.current, className: 'right-view' },
      once: true,
    });
    ScrollTrigger.create({
      ...
      // markers: true,
      start: 'top 80%',
      toggleClass: { targets: jsRef.current, className: 'left-view' },
      once: true,
    });
    ScrollTrigger.create({
      ...
      // markers: true,
      start: 'top 80%',
      toggleClass: { targets: otherRef.current, className: 'right-view' },
      once: true,
    });
  }, []);
